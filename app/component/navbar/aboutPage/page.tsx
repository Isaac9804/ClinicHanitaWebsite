    ...
    <main className="">
      ...
      <div>
        <div className="bg-pink-50 bg-opacity-50 py-12 lg:py-28">
          ...
          <div>
            <div className="overflow-hidden h-[370px] md:h-[670px] lg:h-[770px] xl:h-[970px]  w-10/12 bg-sky-100  mx-auto max-w-[1440px] rounded-2xl drop-shadow-xl">
              <div className="p-7  text-slate-700 md:p-16 lg:p-20 xl:p-24">
                <div className="flex items-center  gap-2 xl:gap-5">
                  <HiMiniInformationCircle className="text-3xl md:text-5xl lg:text-7xl" />
                  <h3 className="font-black text-base md:text-2xl lg:text-4xl">
                    ABOUT US
                  </h3>
                </div>
                <div className="pt-3 text-justify md:pt-10 ">
                  <p className="text-xxs md:text-base xl:text-xl">
              ...
              <div className=" relative transform transition duration-500 hover:scale-110 h-48 md:h-96 lg:h-[500px] xl:h-[750px] 2xl:h-[850px] ">
                <Image
          ...
          <div className="max-w-[1440px] mx-auto">
            <div className="mx-auto w-4/6 mt-12 md:mt-24 ">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-base md:text-2xl lg:text-4x">
                  VISION
                </h3>
              </div>
              <div className=" pt-2 text-xxs md:text-base md:pt-5 xl:text-xl">
                <p>
        ...
        <div className="max-w-[1440px] mx-auto w-10/12 ">
          ...
          {/* ----------------------About Dr Section--------------------------------------- */}
          <div className="">
            <h1 className="text-slate-800 pt-20 pb-10 text-center font-bold md:text-2xl md:pt-40 md:pb-28 lg:text-4xl">
              GET TO KNOW OUR CEO
            </h1>
            <div className=" mx-auto shadow-xl bg-slate-300   lg:flex   rounded-xl  overflow-hidden  xl:h-[700px] ">
              ...
              <div className="p-7  flex-1  md:p-16 xl:p-24">
                <div className="pb-5 lg:pb-5">
                  ...
                  <p className="text-xxs font-bold text-gray-400 lg:text-xs">
                    Doctor and founder of Klinik Hanita
                  </p>
                </div>
                <p className="text-xxs md:text-base  xl:text-lg">
